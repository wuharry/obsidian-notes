...
> [!info] **專案狀態**：Godot 4.7 / Forward+｜**當前版本**：v2.2 整理版
> - **專案文檔**：[[Notion/HD-2D 卡牌對戰 (暫定) - 遊戲設計文件 v2.0|🃏 HD-2D 卡牌對戰企劃]]
> - **核心內容**：
>   - **現行已實作**：10 個從者槽位、魔力自然上限 7、棄牌回魔與隔回合冷卻、120 張實裝卡池（從者/靈裝/秘術/瞬咒/伏印）、秘術拖曳施放（全域/指定目標/回魔區）、戰鬥紀錄抽屜介面 (BattleArchive)、3D 命中/治療/護盾與秘術高清演出、單人 AI 與 NetClient 伺服器對局、8.13.20/12.26.19 圖示與像素動畫素材包。
...
> - **現行核心進度**：出格行為規則防線（封鎖盜竊/非法載具/司法通報追緝）、NPC 肖像與選角職業圖示、響應式透明介面與重點事件 (EventHighlights)、背包道具與世界狀態持久化、怪物生態習性與戰鬥持續態度記憶（停手/退開/重啟敵意）、四項第一章委託、術式面板與故事匯出。
> - **測試與驗收中心**：
